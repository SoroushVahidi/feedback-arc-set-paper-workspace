...
def global_scc_topo_reorder_scores(G, edges, scores, debug=True):
    """
...
final_ranking_path = hybrid_refine_func1_func2(
    ...
    initial_ranking_path="/mmfs1/home/sv96/Feedback-arc-set-paper/datasets/connectome_hybrid_ranking.csv",
    output_ranking_path="/mmfs1/home/sv96/Feedback-arc-set-paper/datasets/connectome_hybrid_ranking.csv",   # 👈 ONE CSV
    log_path="/mmfs1/home/sv96/Feedback-arc-set-paper/datasets//connectome_hybrid_phases_direction_changes_log.txt",
    h_hours=4.0,
